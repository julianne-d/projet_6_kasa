...
export default function StarRating({ rating }) {
    const renderStars = () => {
        ...
        for (let i = 0; i < 5; i++) {
            if (i < rating) {
                stars.push(
                    <svg key={i} className="star star--filled" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" >
                        <path d={starPath}/>
                    </svg>
                );
            } else {
                stars.push(
                    <svg key={i} className="star star--empty" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" >
                       <path d={starPath}/>
                    </svg>
                );
            }
